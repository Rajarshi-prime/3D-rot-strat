...
def RHS(uk, bk,uk_t,bk_t,visc = 1,forc = 1):
    ...
    rhsu[:] = (omg[2]*u[1] - omg[1]*u[2]) + f_corr*u[1]
    rhsv[:] = (omg[0]*u[2] - omg[2]*u[0]) - f_corr*u[0]
    rhsw[:] = (omg[1]*u[0] - omg[0]*u[1]) + b*N_b
    rhsb[:] = - (u[0]*diff_x(b,b1) + u[1]*diff_y(b,b2) + u[2]*diff_z(b,b3)) - N_b*u[2]
